# Verification plan — Windows drivers

Status: NOT RUN. There is no executable implementation to test.

## Module acceptance criteria

### 1. Driver inventory table

- [ ] Define a versioned input fixture specifically for driver inventory table.
...
### 2. Vendor source links

- [ ] Define a versioned input fixture specifically for vendor source links.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.

### 3. Rollback preparation notes

- [ ] Define a versioned input fixture specifically for rollback preparation notes.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.
