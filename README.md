...
<div align="center">
  <img src="./public/logo.svg" alt="DriverLedger — Windows drivers — Drivers" width="64" height="64">
  <h1>DriverLedger — Windows drivers — Drivers</h1>
</div>

An independent project specification for Windows drivers, covering driver inventory table, vendor source links, rollback preparation notes.
...
<img src="./public/screenshots/desktop-main.svg" alt="Windows drivers — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Windows drivers — compact concept, not a screenshot" width="250">
<br>
...
- **Driver inventory table** — planned module; not implemented.
- **Vendor source links** — planned module; not implemented.
- **Rollback preparation notes** — planned module; not implemented.

The proposed workflow separates driver inventory table from vendor source links, with rollback preparation notes retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Driver inventory table**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="DriverLedger — Windows drivers — Drivers — specification review workflow">
<br>
...
Define the input and expected outcome for module 1. Record the Windows drivers version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Vendor source links

Define the input and expected outcome for module 2. Record the Windows drivers version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Rollback preparation notes

Define the input and expected outcome for module 3. Record the Windows drivers version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### At a glance

| Field | Value |
|---|---|
| Target | Windows drivers |
| Category | PC utility specification |
| Input | Manual notes or user-authorized local exports |
| Planned output | Driver inventory table |
