...
独立的项目设计文档，适用对象： **Windows drivers**。
...
- **驱动程序清单** (Driver inventory table) — 规划模块，尚未实现。
- **厂商来源链接** (Vendor source links) — 规划模块，尚未实现。
- **回退准备说明** (Rollback preparation notes) — 规划模块，尚未实现。
